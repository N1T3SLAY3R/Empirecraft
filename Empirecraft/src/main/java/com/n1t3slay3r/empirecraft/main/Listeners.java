...
public class Listeners implements Listener {
        ...
        if (tempHashMap.get("chc").containsKey(player.getUniqueId().toString())) {
            ...
            if (tempHashMap.get("chc").get(player.getUniqueId().toString()).equals("loc")) {
                ...
                if (serverdata.get("villages").get(serverdata.get("playerdata").get(player.getUniqueId().toString()).get("village").toString()).containsKey("mem")) {
                    ((ArrayList<String>) serverdata.get("villages").get(serverdata.get("playerdata").get(player.getUniqueId().toString()).get("village").toString()).get("mem")).stream().filter((s) -> (Bukkit.getPlayer(UUID.fromString(s)).isOnline())).forEach((s) -> {
                ...
                if (serverdata.get("villages").get(serverdata.get("playerdata").get(player.getUniqueId().toString()).get("village").toString()).containsKey("man")) {
                    ((ArrayList<String>) serverdata.get("villages").get(serverdata.get("playerdata").get(player.getUniqueId().toString()).get("village").toString()).get("man")).stream().filter((s) -> (Bukkit.getPlayer(UUID.fromString(s)).isOnline())).forEach((s) -> {
                        event.getRecipients().add(Bukkit.getPlayer(UUID.fromString(s)));
                    });
                }
                ...
                if (serverdata.get("villages").get(serverdata.get("playerdata").get(player.getUniqueId().toString()).get("village").toString()).containsKey("all")) {
                    ((ArrayList<String>) serverdata.get("villages").get(serverdata.get("playerdata").get(player.getUniqueId().toString()).get("village").toString()).get("all")).stream().map((v) -> {
                        if (serverdata.get("villages").get(v).containsKey("mem")) {
                            ((ArrayList<String>) serverdata.get("villages").get(v).get("mem")).stream().filter((s) -> (Bukkit.getPlayer(UUID.fromString(s)).isOnline())).forEach((s) -> {
                                event.getRecipients().add(Bukkit.getPlayer(UUID.fromString(s)));
                            });
                        }
                        return v;
                        ...
                        if (serverdata.get("villages").get(v).containsKey("man")) {
                            ((ArrayList<String>) serverdata.get("villages").get(v).get("man")).stream().filter((s) -> (Bukkit.getPlayer(UUID.fromString(s)).isOnline())).forEach((s) -> {
                                event.getRecipients().add(Bukkit.getPlayer(UUID.fromString(s)));
                            });
                        }
                        return v;
                    }).filter((v) -> (Bukkit.getPlayer(UUID.fromString(serverdata.get("villages").get(v).get("own").toString())).isOnline())).forEach((v) -> {
    ...
    public void onBlockMove(BlockFromToEvent event) {
        ...
        if (MainConversions.isWorldChunkClaimed(serverdata.get("worldmap").get(world), x, z, "cla")) {
            if (((HashMap) ((HashMap) serverdata.get("worldmap").get(world).get(x)).get(z)).containsKey("str") && !((HashMap) ((HashMap) serverdata.get("worldmap").get(world).get(x)).get(z)).containsKey("con")) {
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        ...
        if (!tempHashMap.get("lcx").get(playerid).equals(player.getLocation().getChunk().getX()) || !tempHashMap.get("lcz").get(playerid).equals(player.getLocation().getChunk().getZ())) {
            if (MainConversions.isWorldChunkClaimed(serverdata.get("worldmap").get(player.getWorld().getUID().toString()), ((Integer) tempHashMap.get("lcx").get(playerid)), ((Integer) tempHashMap.get("lcz").get(playerid)), "cla")) {
                if (MainConversions.isWorldChunkClaimed(serverdata.get("worldmap").get(player.getWorld().getUID().toString()), player.getLocation().getChunk().getX(), player.getLocation().getChunk().getZ(), "cla")) {
                    if (!((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(tempHashMap.get("lcx").get(playerid))).get(tempHashMap.get("lcz").get(playerid))).get("cla").equals(((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(player.getLocation().getChunk().getX())).get(player.getLocation().getChunk().getZ())).get("cla"))) {
                        player.sendMessage(ChatColor.YELLOW + "*You are now leaving the village " + ChatColor.GOLD + ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(tempHashMap.get("lcx").get(playerid))).get(tempHashMap.get("lcz").get(playerid))).get("cla") + ChatColor.YELLOW + " and entering " + ChatColor.GOLD + ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(player.getLocation().getChunk().getX())).get(player.getLocation().getChunk().getZ())).get("cla") + ChatColor.YELLOW + "*");
                    }
                } else {
                    player.sendMessage(ChatColor.YELLOW + "*You are now leaving the village " + ChatColor.GOLD + ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(tempHashMap.get("lcx").get(playerid))).get(tempHashMap.get("lcz").get(playerid))).get("cla") + ChatColor.YELLOW + "*");
                }
            } else if (MainConversions.isWorldChunkClaimed(serverdata.get("worldmap").get(player.getWorld().getUID().toString()), player.getLocation().getChunk().getX(), player.getLocation().getChunk().getZ(), "cla")) {
                player.sendMessage(ChatColor.YELLOW + "*You are now entering the village " + ChatColor.GOLD + ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(player.getLocation().getChunk().getX())).get(player.getLocation().getChunk().getZ())).get("cla") + ChatColor.YELLOW + "*");
            }
            ...
            if (MainConversions.isPartInHashMap(serverdata.get("playerdata"), playername, "village")) {
                ...
                if (pvillage.equals(evillage)) {
                    ...
                    if (MainConversions.enemyEmpire(pvillage, evillage) && MainConversions.isPartInHashMap(serverdata.get("villages").get(evillage), "ene", pvillage)) {
                        if (((HashMap) serverdata.get("empires").get(serverdata.get("villages").get(pvillage).get("emp").toString()).get("ene")).get(serverdata.get("empires").get(serverdata.get("villages").get(evillage).get("emp").toString())) == null || ((HashMap) serverdata.get("villages").get(evillage).get("ene")).get(pvillage) == null) {
                            if (((HashMap) ((HashMap) serverdata.get("worldmap").get(world).get(x)).get(z)).containsKey("str") && !Config.getStringList("Village Settings.Placeable/Destroyble Blocks In Structures").contains(mat.toString())) {
                                if (MainConversions.listenerBlockBreak(world, x, z, player, mat, evillage, playername)) {
                                    event.setCancelled(true);
                                }
                            }
                        } else if (Integer.parseInt(((HashMap) serverdata.get("empires").get(serverdata.get("villages").get(pvillage).get("emp").toString()).get("ene")).get(serverdata.get("empires").get(serverdata.get("villages").get(evillage).get("emp").toString())).toString()) >= Integer.parseInt(((HashMap) serverdata.get("villages").get(evillage).get("ene")).get(pvillage).toString())) {
    ...
    public void onPlayerOpenChest(InventoryOpenEvent event) {
        ...
        if (inv.equals(InventoryType.CHEST) || inv.equals(InventoryType.ANVIL) || inv.equals(InventoryType.BEACON) || inv.equals(InventoryType.BREWING) || inv.equals(InventoryType.DISPENSER) || inv.equals(InventoryType.DROPPER) || inv.equals(InventoryType.FURNACE) || inv.equals(InventoryType.HOPPER)) {
            Block targetblock = ((Block) event.getPlayer().getTargetBlock(null, 9));
            ...
            if (MainConversions.isWorldChunkClaimed(serverdata.get("worldmap").get(world), cx, cz, "cla")) {
                if (MainConversions.isPartInHashMap(serverdata.get("playerdata"), playername, "village")) {
                    ...
                    if (pvillage.equals(evillage)) {
                        ...
                        } else if (playername.equals(serverdata.get("villages").get(pvillage).get("own"))) {
                            //Do nothing/let event occur
                        } else {
                            event.setCancelled(true);
                        }
                    ...
                    if (targetblock.getChunk().equals((Chunk) ((HashMap) tempHashMap.get("mainchest").get(playername)).get("chunk"))) {
                        if (targetblock.getY() >= ((Integer) ((HashMap) tempHashMap.get("mainchest").get(playername)).get("baseheight")) && targetblock.getY() <= (((Integer) ((HashMap) tempHashMap.get("mainchest").get(playername)).get("height")) + ((Integer) ((HashMap) tempHashMap.get("mainchest").get(playername)).get("baseheight")))) {
                            ...
                            if (((HashMap) tempHashMap.get("mainchest").get(playername)).get("type").equals("normal")) {
                                ...
                                Config.set("Village Structures." + ((HashMap) tempHashMap.get("mainchest").get(playername)).get("name") + ".Produced Materials", new ArrayList());
