                                    ...
                                    if (Config.isConfigurationSection("Village Structures." + tempstring)) {
                                        if (!Config.isList("Village Structures." + tempstring + ".Upgraded From")) {
                                            if (econ.has(player, Config.getInt("Village Structures." + tempstring + ".Creation Cost"))) {
                                                ...
                                                ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(player.getLocation().getChunk().getX())).get(player.getLocation().getChunk().getZ())).put("con", true);
                                                ...
                                                ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(player.getLocation().getChunk().getX())).get(player.getLocation().getChunk().getZ())).put("cle", true);
                                                ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(player.getLocation().getChunk().getX())).get(player.getLocation().getChunk().getZ())).put("base", player.getLocation().getBlockY());
            ...
            if (Config.getInt("Village Settings.Destruction Delay") == 0) {
                ...
                if (Config.getInt("Village Settings.Build Delay") == 0) {
                    ...
                    if (Config.isConfigurationSection("Village Ranks." + structure)) {
                        ...
                        ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(player.getLocation().getChunk().getX())).get(player.getLocation().getChunk().getX())).replace("hp", Config.getInt("Village Structures." + ((HashMap) ((HashMap) serverdata.get("worldmap").get(player.getWorld().getUID().toString()).get(player.getLocation().getChunk().getX())).get(player.getLocation().getChunk().getZ())).get("str") + ".Total Hp"));
                    }
                }
            }
